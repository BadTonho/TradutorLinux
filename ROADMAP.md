...
- **Próximo resultado observável:** a próxima fronteira da GUI mínima ainda está por decidir — candidatos: desenho de formas (`Rectangle`/`FillRect`), fontes/cores ou a entrada de mouse completa. Decidir com fixture e teste de integração antes de implementar.
