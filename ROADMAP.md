...
- **Próximo resultado observável:** validar `bzip2.exe` de ponta a ponta com os imports de KERNEL32 e msvcrt.dll todos implementados; criar golden fixtures e teste e2e (requer mingw-w64 para cross-build). `dos2unix`/`unix2dos` dependem de `SHELL32.dll!CommandLineToArgvW` e do caminho `W` (Fase 10+).
