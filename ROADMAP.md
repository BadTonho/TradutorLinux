...
- **Marco concluído:** o alvo pinado `Efeckc17/simple-todo-c` (`bcdf3d5fcebb8c0b445edb791d54511194c1b6ca`) compila como PE32+ x64 com manifesto/ícone e tem metadata e `--report` protegidos. O relatório resolve **110/110 imports**; `USER32` possui controles lógicos EDIT/BUTTON/COMBOBOX/STATIC/SysListView32, comandos/notificações, foco e teclado; `ADVAPI32` persiste o autorun limitado e `SHELL32` usa menu X11 como bandeja emulada. Em 2026-08-19, `targetapp_simple_todo_gui_smoke` passou localmente sob Xvfb, cobrindo adicionar, editar, buscar, concluir, excluir, autorun, esconder, mostrar, persistência e saída.
