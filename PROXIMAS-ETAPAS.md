...
da suíte Win32, shell visual do 7-Zip e catálogo. A ausência do executável
comercial Worker/RSL continua aberta no item `B6`. Desde a redação original
deste arquivo, os itens `B1`, `B4`, `B5`, `B7`, `B8`, `B10`, `B12`, `B15` e
`B16` foram implementados e validados; as condições ainda abertas estão
descritas somente no backlog atual do roadmap.
