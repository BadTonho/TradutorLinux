...
| 5 | `WinRAR_x64.exe` `winrar-x64-723.exe` | PE32+ x86-64 | 251/251 (100%) | `supported` | `ExitProcess 0` no cenário SFX controlado; sob Xvfb sem interação, D4 termina em `guest-timeout 72` | delay `GDI32/ADVAPI32/SHELL32/ole32`; o timeout sem interação não é suporte funcional |
