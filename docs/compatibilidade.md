...
| `KERNEL32.dll` | `GetACP`, `GetOEMCP`, `GetCPInfo`, `GetLocaleInfoW`, `LCMapStringW/Ex` | Suportado no subconjunto determinístico | `en-US`/`0x0409`, ACP 1252 e OEMCP 437; locale info estático e case mapping ASCII/Latin-1; sort keys, CJK e enumeração ampla não entram |
