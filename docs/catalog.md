...
- `7zFM_x64.exe` (7-Zip GUI): **298/298 (100%)** imports resolvidos; há um shell visual experimental para `7-Zip::FM` com listagem imediata do diretório do executável, seleção, árvore lateral, barra de endereço restrita à raiz e navegação visual por pastas via Enter ou duplo clique, mas comandos de arquivo ainda não estão ligados
