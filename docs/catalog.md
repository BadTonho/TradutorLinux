...
| `7zFM_x64.exe` | 298 | **shell visual experimental** | menu, toolbar, endereço, navegação e lista são desenhados; a lista mostra entradas imediatas do diretório do executável, limitada a 128 linhas, permite seleção e abre pastas por Enter ou duplo clique; comandos reais ainda não estão ligados |
...
entradas e abrir pastas por Enter ou duplo clique. A validação complementar de GUI passou em `x11_popup_smoke` e
...
- `7zFM_x64.exe` (7-Zip GUI): **298/298 (100%)** imports resolvidos; há um shell visual experimental para `7-Zip::FM` com listagem imediata do diretório do executável, seleção e navegação visual por pastas via Enter ou duplo clique, mas comandos de arquivo ainda não estão ligados
