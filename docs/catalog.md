...
entradas e abrir pastas por Enter ou duplo clique; a árvore lateral permite
retornar à raiz visual e selecionar diretórios Linux conhecidos. A validação complementar de GUI passou em `x11_popup_smoke` e
...
- `7zFM_x64.exe` (7-Zip GUI): **298/298 (100%)** imports resolvidos; há um shell visual experimental para `7-Zip::FM` com listagem imediata do diretório do executável, seleção, árvore lateral e navegação visual por pastas via Enter ou duplo clique, mas comandos de arquivo ainda não estão ligados
