...
registros de análise e as propostas em `docs/` permanecem apenas como
referências históricas; as próximas tarefas agora são registradas no
...
registros de análise, `docs/propostas-evolucao.md` e da proposta de
