...
void register_user32_module() {
    static const ExportedFunction kUser32Exports[] = {
        ...
        {"GetMenuItemInfoW", 129, reinterpret_cast<std::uintptr_t>(&tl_GetMenuItemInfoW), ExportSupport::Stub},
        ...
        {"EnableMenuItem", 133, reinterpret_cast<std::uintptr_t>(&tl_EnableMenuItem), ExportSupport::Stub},
        {"CheckMenuItem", 134, reinterpret_cast<std::uintptr_t>(&tl_CheckMenuItem), ExportSupport::Stub},
        {"CheckMenuRadioItem", 135, reinterpret_cast<std::uintptr_t>(&tl_CheckMenuRadioItem), ExportSupport::Stub},
