...
void register_oleaut32_module() {
    static const ExportedFunction kOleaut32Exports[] = {
        {"SysAllocString", 2, reinterpret_cast<std::uintptr_t>(&tl_SysAllocString), ExportSupport::Full},
        {"SysReAllocString", 3, reinterpret_cast<std::uintptr_t>(&tl_SysReAllocString), ExportSupport::Full},
        {"SysAllocStringLen", 4, reinterpret_cast<std::uintptr_t>(&tl_SysAllocStringLen), ExportSupport::Full},
        {"SysReAllocStringLen", 5, reinterpret_cast<std::uintptr_t>(&tl_SysReAllocStringLen), ExportSupport::Full},
        {"SysFreeString", 6, reinterpret_cast<std::uintptr_t>(&tl_SysFreeString), ExportSupport::Full},
        {"SysStringLen", 7, reinterpret_cast<std::uintptr_t>(&tl_SysStringLen), ExportSupport::Full},
        {"VariantInit", 8, reinterpret_cast<std::uintptr_t>(&tl_VariantInit), ExportSupport::Full},
        {"VariantClear", 9, reinterpret_cast<std::uintptr_t>(&tl_VariantClear), ExportSupport::Full},
        {"VariantCopy", 10, reinterpret_cast<std::uintptr_t>(&tl_VariantCopy), ExportSupport::Full},
        {"VariantCopyInd", 11, reinterpret_cast<std::uintptr_t>(&tl_VariantCopyInd), ExportSupport::Full},
        {"VariantChangeType", 12, reinterpret_cast<std::uintptr_t>(&tl_VariantChangeType), ExportSupport::Full},
        {"SafeArrayCreate", 15, reinterpret_cast<std::uintptr_t>(&tl_SafeArrayCreate), ExportSupport::Full},
        {"SafeArrayDestroy", 16, reinterpret_cast<std::uintptr_t>(&tl_SafeArrayDestroy), ExportSupport::Full},
        {"SafeArrayGetDim", 17, reinterpret_cast<std::uintptr_t>(&tl_SafeArrayGetDim), ExportSupport::Full},
        {"SafeArrayGetElemsize", 18, reinterpret_cast<std::uintptr_t>(&tl_SafeArrayGetElemsize), ExportSupport::Full},
        {"SafeArrayGetUBound", 19, reinterpret_cast<std::uintptr_t>(&tl_SafeArrayGetUBound), ExportSupport::Full},
        {"SafeArrayGetLBound", 20, reinterpret_cast<std::uintptr_t>(&tl_SafeArrayGetLBound), ExportSupport::Full},
        {"SafeArrayLock", 21, reinterpret_cast<std::uintptr_t>(&tl_SafeArrayLock), ExportSupport::Full},
        {"SafeArrayUnlock", 22, reinterpret_cast<std::uintptr_t>(&tl_SafeArrayUnlock), ExportSupport::Full},
        {"SafeArrayAccessData", 23, reinterpret_cast<std::uintptr_t>(&tl_SafeArrayAccessData), ExportSupport::Full},
        {"SafeArrayUnaccessData", 24, reinterpret_cast<std::uintptr_t>(&tl_SafeArrayUnaccessData), ExportSupport::Full},
        {"VariantChangeTypeEx", 147, reinterpret_cast<std::uintptr_t>(&tl_VariantChangeTypeEx), ExportSupport::Full},
        {"SysStringByteLen", 149, reinterpret_cast<std::uintptr_t>(&tl_SysStringByteLen), ExportSupport::Full},
        {"SysAllocStringByteLen", 150, reinterpret_cast<std::uintptr_t>(&tl_SysAllocStringByteLen), ExportSupport::Full},
        {"SafeArrayDestroyData", 200, reinterpret_cast<std::uintptr_t>(&tl_SafeArrayDestroyData), ExportSupport::Full},
        {"SafeArrayDestroyDescriptor", 201, reinterpret_cast<std::uintptr_t>(&tl_SafeArrayDestroyDescriptor), ExportSupport::Full},
        {"SafeArrayCreateVector", 411, reinterpret_cast<std::uintptr_t>(&tl_SafeArrayCreateVector), ExportSupport::Full},
    };
