...
void register_ole32_module() {
    static const ExportedFunction kOle32Exports[] = {
        {"CoInitialize", 1, reinterpret_cast<std::uintptr_t>(&tl_CoInitialize), ExportSupport::Full},
        {"CoInitializeEx", 2, reinterpret_cast<std::uintptr_t>(&tl_CoInitializeEx), ExportSupport::Full},
        {"CoUninitialize", 3, reinterpret_cast<std::uintptr_t>(&tl_CoUninitialize), ExportSupport::Full},
        {"CoCreateGuid", 4, reinterpret_cast<std::uintptr_t>(&tl_CoCreateGuid), ExportSupport::Full},
        {"CoTaskMemAlloc", 5, reinterpret_cast<std::uintptr_t>(&tl_CoTaskMemAlloc), ExportSupport::Full},
        {"CoTaskMemFree", 6, reinterpret_cast<std::uintptr_t>(&tl_CoTaskMemFree), ExportSupport::Full},
        {"CoTaskMemRealloc", 7, reinterpret_cast<std::uintptr_t>(&tl_CoTaskMemRealloc), ExportSupport::Full},
        {"CreateStreamOnHGlobal", 12, reinterpret_cast<std::uintptr_t>(&tl_CreateStreamOnHGlobal), ExportSupport::Full},
        {"CoCreateInstance", 8, reinterpret_cast<std::uintptr_t>(&tl_CoCreateInstance), ExportSupport::Full},
        {"CoGetClassObject", 9, reinterpret_cast<std::uintptr_t>(&tl_CoGetClassObject), ExportSupport::Full},
        {"OleInitialize", 10, reinterpret_cast<std::uintptr_t>(&tl_OleInitialize), ExportSupport::Full},
        {"OleUninitialize", 11, reinterpret_cast<std::uintptr_t>(&tl_OleUninitialize), ExportSupport::Full},
        {"CLSIDFromString", 13, reinterpret_cast<std::uintptr_t>(&tl_CLSIDFromString), ExportSupport::Full},
        {"RegisterDragDrop", 14, reinterpret_cast<std::uintptr_t>(&tl_RegisterDragDrop), ExportSupport::Full},
        {"RevokeDragDrop", 15, reinterpret_cast<std::uintptr_t>(&tl_RevokeDragDrop), ExportSupport::Full},
        {"DoDragDrop", 16, reinterpret_cast<std::uintptr_t>(&tl_DoDragDrop), ExportSupport::Full},
        {"ReleaseStgMedium", 17, reinterpret_cast<std::uintptr_t>(&tl_ReleaseStgMedium), ExportSupport::Full},
        {"StringFromGUID2", 18, reinterpret_cast<std::uintptr_t>(&tl_StringFromGUID2), ExportSupport::Full},
        {"CLSIDFromProgID", 19, reinterpret_cast<std::uintptr_t>(&tl_CLSIDFromProgID), ExportSupport::Full},
        {"CoGetMalloc", 20, reinterpret_cast<std::uintptr_t>(&tl_CoGetMalloc), ExportSupport::Full},
    };
