...
void register_comctl32_module() {
    static const ExportedFunction kComctl32Exports[] = {
        {"InitCommonControls", 1, reinterpret_cast<std::uintptr_t>(&tl_InitCommonControls), ExportSupport::Full},
        {"InitCommonControlsEx", 2, reinterpret_cast<std::uintptr_t>(&tl_InitCommonControlsEx), ExportSupport::Full},
        {"ImageList_Create", 3, reinterpret_cast<std::uintptr_t>(&tl_ImageList_Create), ExportSupport::Full},
        {"ImageList_Destroy", 4, reinterpret_cast<std::uintptr_t>(&tl_ImageList_Destroy), ExportSupport::Full},
        {"ImageList_Add", 5, reinterpret_cast<std::uintptr_t>(&tl_ImageList_Add), ExportSupport::Full},
        {"ImageList_AddMasked", 6, reinterpret_cast<std::uintptr_t>(&tl_ImageList_AddMasked), ExportSupport::Full},
        {"ImageList_ReplaceIcon", 7, reinterpret_cast<std::uintptr_t>(&tl_ImageList_ReplaceIcon), ExportSupport::Full},
        {"CreateStatusWindowW", 8, reinterpret_cast<std::uintptr_t>(&tl_CreateStatusWindowW), ExportSupport::Full},
        {"CreateToolbarEx", 9, reinterpret_cast<std::uintptr_t>(&tl_CreateToolbarEx), ExportSupport::Full},
        {"ImageList_GetImageCount", 10, reinterpret_cast<std::uintptr_t>(&tl_ImageList_GetImageCount), ExportSupport::Full},
        {"PropertySheetW", 11, reinterpret_cast<std::uintptr_t>(&tl_PropertySheetW), ExportSupport::Full},
        {"TaskDialogIndirect", 12, reinterpret_cast<std::uintptr_t>(&tl_TaskDialogIndirect), ExportSupport::Full},
        {"TaskDialog", 13, reinterpret_cast<std::uintptr_t>(&tl_TaskDialog), ExportSupport::Full},
        {"ImageList_Draw", 14, reinterpret_cast<std::uintptr_t>(&tl_ImageList_Draw), ExportSupport::Full},
        {"ImageList_DrawEx", 15, reinterpret_cast<std::uintptr_t>(&tl_ImageList_DrawEx), ExportSupport::Full},
        {"ImageList_GetIcon", 16, reinterpret_cast<std::uintptr_t>(&tl_ImageList_GetIcon), ExportSupport::Full},
        {"ImageList_Duplicate", 17, reinterpret_cast<std::uintptr_t>(&tl_ImageList_Duplicate), ExportSupport::Full},
        {"ImageList_SetBkColor", 18, reinterpret_cast<std::uintptr_t>(&tl_ImageList_SetBkColor), ExportSupport::Full},
        {"ImageList_GetBkColor", 19, reinterpret_cast<std::uintptr_t>(&tl_ImageList_GetBkColor), ExportSupport::Full},
        {"ImageList_GetIconSize", 20, reinterpret_cast<std::uintptr_t>(&tl_ImageList_GetIconSize), ExportSupport::Full},
        {"_TrackMouseEvent", 21, reinterpret_cast<std::uintptr_t>(&tl_TrackMouseEvent_alias), ExportSupport::Full},
        {"ImageList_GetImageInfo", 22, reinterpret_cast<std::uintptr_t>(&tl_ImageList_GetImageInfo), ExportSupport::Full},
        {"ImageList_EndDrag", 23, reinterpret_cast<std::uintptr_t>(&tl_ImageList_EndDrag), ExportSupport::Full},
        {"ImageList_DragShowNolock", 24, reinterpret_cast<std::uintptr_t>(&tl_ImageList_DragShowNolock), ExportSupport::Full},
        {"ImageList_DragEnter", 25, reinterpret_cast<std::uintptr_t>(&tl_ImageList_DragEnter), ExportSupport::Full},
        {"ImageList_DragMove", 26, reinterpret_cast<std::uintptr_t>(&tl_ImageList_DragMove), ExportSupport::Full},
        {"ImageList_BeginDrag", 27, reinterpret_cast<std::uintptr_t>(&tl_ImageList_BeginDrag), ExportSupport::Full},
        {"ImageList_Remove", 28, reinterpret_cast<std::uintptr_t>(&tl_ImageList_Remove), ExportSupport::Full},
        {"ImageList_SetIconSize", 29, reinterpret_cast<std::uintptr_t>(&tl_ImageList_SetIconSize), ExportSupport::Full},
        {"CreateToolbarEx", 30, reinterpret_cast<std::uintptr_t>(&tl_CreateToolbarEx), ExportSupport::Full},
        {"LoadIconWithScaleDown", 381, reinterpret_cast<std::uintptr_t>(&tl_LoadIconWithScaleDown), ExportSupport::Full},
        {"SetWindowSubclass", 410, reinterpret_cast<std::uintptr_t>(&tl_SetWindowSubclass), ExportSupport::Full},
        {"RemoveWindowSubclass", 412, reinterpret_cast<std::uintptr_t>(&tl_RemoveWindowSubclass), ExportSupport::Full},
        {"DefSubclassProc", 413, reinterpret_cast<std::uintptr_t>(&tl_DefSubclassProc), ExportSupport::Full},
        {"", 17, reinterpret_cast<std::uintptr_t>(&tl_InitCommonControls), ExportSupport::Full},
        {"", 381, reinterpret_cast<std::uintptr_t>(&tl_LoadIconWithScaleDown), ExportSupport::Full},
        {"", 410, reinterpret_cast<std::uintptr_t>(&tl_SetWindowSubclass), ExportSupport::Full},
        {"", 411, reinterpret_cast<std::uintptr_t>(&tl_TaskDialogIndirect), ExportSupport::Full},
        {"", 412, reinterpret_cast<std::uintptr_t>(&tl_RemoveWindowSubclass), ExportSupport::Full},
        {"", 413, reinterpret_cast<std::uintptr_t>(&tl_DefSubclassProc), ExportSupport::Full},
    };
