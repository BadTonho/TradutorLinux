...
LeakSanitizer). Desde então, `B1`, `B4`, `B5`, `B7`, `B8`, `B10`, `B12`, `B15`
e `B16` foram implementados e validados; `B2`, `B6` e `B9` permanecem
condicionados no
backlog atual. Os achados já corrigidos — isolamento, estado GUI, parser MSIX,
forwarders, TLS, memória virtual, drives do prefixo, helpers e stubs — estão
marcados como absorvidos no roadmap e
não devem ser reabertos sem nova evidência.

Não adicione novas pendências neste arquivo. A fonte de verdade é sempre o
`feitos/ROADMAP-LEGADO.md`.
