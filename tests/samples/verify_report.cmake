...
if(NOT DEFINED PREFIX_DIR)
    string(SHA256 prefix_key "${INPUT}|${EXPECTED_SYMBOL}|${EXPECTED_SUPPORT}|${EXPECT_USER32}")
    string(SUBSTRING "${prefix_key}" 0 16 prefix_suffix)
    set(PREFIX_DIR "${CMAKE_CURRENT_BINARY_DIR}/default-report-prefix-${prefix_suffix}")
endif()
