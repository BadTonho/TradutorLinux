...
if(DEFINED EXPECT_USER32)
    list(APPEND required_items "USER32.dll!MessageBoxA status=resolved")
else()
    list(APPEND required_items "KERNEL32.dll!VirtualAlloc status=resolved")
endif()
