...
endforeach()
tl_assert_profile_parser("${native_trace_a}" "success" "native run A profile")
...
if(RUST_ENABLED)
    tl_assert_profile_parser("${invalid_trace}" "malformed" "invalid profile Rust parser")
    tl_assert_no_path_validation("${invalid_trace}" "invalid profile after Rust parser rejection")
else()
...
tl_assert_profile_parser("${proton_trace}" "success" "Proton profile")
