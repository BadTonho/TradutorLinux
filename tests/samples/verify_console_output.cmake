...
if(NOT DEFINED PREFIX_DIR)
    string(SHA256 prefix_key "${INPUT}|${EXPECTED_HEX}|${INPUT_TEXT}|${EXTRA_ARGS}")
    string(SUBSTRING "${prefix_key}" 0 16 prefix_suffix)
    set(PREFIX_DIR "${CMAKE_CURRENT_BINARY_DIR}/default-prefix-${prefix_suffix}")
endif()
