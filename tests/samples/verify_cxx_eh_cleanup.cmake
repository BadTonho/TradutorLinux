...
if(NOT runtime_stdout STREQUAL "")
    message(FATAL_ERROR "C++ EH cleanup fixture wrote to stdout")
endif()

string(FIND "${runtime_trace}" "[tl][runtime][info] cxx-eh state=\"matched\" detail=\"termination-cleanup\"" cleanup_position)
if(cleanup_position EQUAL -1)
    message(FATAL_ERROR "C++ EH termination cleanup was not selected:\n${runtime_trace}")
endif()
...
if(exit_position EQUAL -1)
    message(FATAL_ERROR "C++ EH cleanup did not reach the successful catch continuation:\n${runtime_trace}")
endif()
