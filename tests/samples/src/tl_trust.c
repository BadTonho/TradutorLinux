...
static const char kRootHex[] =
    "";
...
void tl_entry(void) {
    ...
    dword_t root_length = decode_hex(kRootHex, root);
    ...
    if (WinVerifyTrust((void*)0, kAction, &data) != 0) fail(output, 2);

    data.ui_choice = 1;
    if (WinVerifyTrust((void*)0, kAction, &data) != (hresult_t)0x80070057) fail(output, 3);
    data.ui_choice = 2;

    blob.cb_mem_object = make_payload(payload, leaf, leaf_length, leaf, leaf_length);
    if (WinVerifyTrust((void*)0, kAction, &data) == 0) fail(output, 4);

    static const char message[] = "trust\n";
    dword_t written = 0;
