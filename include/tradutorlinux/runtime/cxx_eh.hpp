...
// relativo à imagem e handlers catch-all; metadados desconhecidos continuam em
// busca de outro handler e acabam no caminho controlado de exceção não tratada.
